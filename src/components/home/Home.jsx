    ...
    <section className="flex bg-[#072e33] w-full h-screen items-center justify-between py-2 relative overflow-hidden">
      <article className="flex h-full md:w-1/2 items-center mt-16 z-10 font-light">
        <div className="relative mt-0">
          <h1 className="text-[#d4f1ff] md:text-4xl text-2xl mb-2 md:px-10 px-4">I'm</h1>
          ...
          <div className="flex items-center bg-[#06292e] border-t-[1px] border-r-[1px] border-[#1e4045] md:w-10/12 py-3 rounded-e-full md:px-10 pl-4 pr-5 slide-in">
