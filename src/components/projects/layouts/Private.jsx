const Private = () => {
  return (
    <section className="flex flex-col justify-center items-center h-[80%] w-full space-y-2 p-2 z-10 text-center text-white">
      ...
      <p className="text-xl font-bold border-b pb-4">
      ...
      <ol className="pt-4 w-2/3 space-y-2">
        <li>
          <p className=" text-lg">
        ...
        <li>
          ...
          <p className="text-gray-300">
            ...
            información del análisis, permitiendo a las veterinarias tener un
            documento con los datos necesarios del análisis del paciente en un orden, formato accesible y
            cómodo para las mismas. En este desarrollo pude aprender nuevos
            conceptos, nuevas herramientas como React-PDF, pulir métodos y
            herramientas de trabajo, además de superar las expectativas del cliente.
          </p>
        </li>
      </ol>
    </section>
